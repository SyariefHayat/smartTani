...
describe('Authorize Middleware', () => {
  ...
  it('should call next() if user role is allowed', () => {
    ...
    const middleware = authorize(['admin', 'petani']);
  ...
  it('should call next with error if user role is not allowed', () => {
    mockRequest.user = { id: '1', role: 'buyer', email: 'buyer@test.com' };
    const middleware = authorize(['admin', 'petani']);
  ...
  it('should call next with 401 if user is missing in request', () => {
