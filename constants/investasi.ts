...
export const INVESTASI_KEUNGGULAN = {
...
export const INVESTASI_TESTIMONI = {
...
export const INVESTASI_PORTOFOLIO_DUMMY = {
...
export const INVESTASI_CTA_BANNER = {
