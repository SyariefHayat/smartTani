  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-heading-3 text-foreground">{INVESTASI_PORTOFOLIO_DUMMY.heading}</h2>
          <p className="text-caption text-muted-foreground">{INVESTASI_PORTOFOLIO_DUMMY.subtext}</p>
        </div>
