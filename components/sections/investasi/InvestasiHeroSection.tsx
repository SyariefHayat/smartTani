    ...
    <section className="relative flex items-start overflow-hidden min-h-[850px] md:min-h-[460px] lg:min-h-[420px]">
      ...
      <div className="absolute inset-0 z-0">
        <picture className="block w-full h-full">
          <source media="(min-width: 1024px)" srcSet={INVESTASI_HERO.bgImageDesktop} />
          <source media="(min-width: 768px) and (max-width: 1023px)" srcSet={INVESTASI_HERO.bgImageTablet} />
          <source media="(max-width: 767px)" srcSet={INVESTASI_HERO.bgImageMobile} />
          <img
            src={INVESTASI_HERO.bgImageDesktop}
