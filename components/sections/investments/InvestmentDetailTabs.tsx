      ...
      <div className="py-8">
        ...
        {activeTab === "tim" && (
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { name: "Arif Wijaya", role: "Manager Proyek", image: "/images/about/director-arif-wijaya.jpeg" },
              { name: "Budi Santoso", role: "Ahli Agronomi", image: "/images/about/director-budi-santoso.jpeg" },
              { name: "Siti Aminah", role: "Ops Manager", image: "/images/about/director-siti-aminah.jpeg" },            ].map((member, i) => (
