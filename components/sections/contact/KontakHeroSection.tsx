    ...
    <section className="relative flex items-starts overflow-hidden min-h-[850px] md:min-h-[460px] lg:min-h-[420px]">
      ...
      <div className="absolute inset-0 z-0">
        <picture className="block w-full h-full">
          <source media="(min-width: 1024px)" srcSet={CONTACT_HERO.bgImageDesktop} />
          <source media="(min-width: 768px) and (max-width: 1023px)" srcSet={CONTACT_HERO.bgImageTablet} />
          <source media="(max-width: 767px)" srcSet={CONTACT_HERO.bgImageMobile} />
          <img
            src={CONTACT_HERO.bgImageDesktop}
        ...
        <div className="grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-12 lg:items-center lg:gap-8">
          ...
          <div className="lg:col-span-9">
            ...
            {/* <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 md:grid-cols-3 max-w-md lg:max-w-xl">
              {CONTACT_HERO.features.map((feature, index) => {
