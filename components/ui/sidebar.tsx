...
>(
  (
    ...
    // We add a state so that we can use it to style the sidebar.
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:visible",
        className
      )}
      {...props}
    />
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:-ml-2 group-data-[collapsible=icon]:opacity-0",
        className
      )}
      {...props}
    />
