...
export default function PetaniDashboard() {
  ...
  const sidebarMenu = [
    { label: "Beranda Dashboard", icon: Home, active: true, href: "/dashboard/farmer" },
    { label: "Produk Saya", icon: Package, active: false, href: "/dashboard/farmer" },
    { label: "Pesanan", icon: ClipboardList, active: false, href: "/dashboard/farmer" },
    { label: "Transaksi", icon: Wallet, active: false, href: "/dashboard/farmer" },
