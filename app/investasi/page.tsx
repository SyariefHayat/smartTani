        ...
        <div className="container-smarttani">
          ...
          <div className="mt-8 rounded-2xl bg-primary-dark p-6 text-white flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-bold text-body-sm md:text-body">{INVESTASI_KEUNGGULAN.tagline}</h3>
                <p className="text-caption text-white/80">{INVESTASI_KEUNGGULAN.taglineSubtext}</p>
              </div>
            </div>
