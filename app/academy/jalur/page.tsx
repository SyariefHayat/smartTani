    ...
    <main className="min-h-screen bg-white pb-20">
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-5xl mx-auto space-y-24">
          {ACADEMY_JALUR.items.map((jalur, idx) => {
            ...
            return (
              <div key={jalur.level} className="relative">
                ...
                {/* Connector */}
                {idx < ACADEMY_JALUR.items.length - 1 && (
                  <div className="flex flex-col items-center mt-24">
                    ...
                    <div className="bg-slate-50 px-6 py-2 rounded-full border border-slate-100 text-xs font-bold text-slate-400 flex items-center gap-3">
                      <span>Selesaikan Jalur {jalur.level} untuk membuka Jalur {ACADEMY_JALUR.items[idx+1].level}</span>
