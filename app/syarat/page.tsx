...
import { SYARAT_META, SYARAT_CONTENT } from "@/constants/syarat";

export const metadata: Metadata = {
  title: SYARAT_META.title,
  description: SYARAT_META.description,
};
      ...
      <article className="container-smarttani max-w-3xl mx-auto py-12 md:py-16 lg:py-20">
        ...
        <header className="text-center mb-12">
          ...
          <h1 className="text-heading-1 md:text-display text-foreground mb-4">
            {SYARAT_CONTENT.heading}
          </h1>
          <p className="text-body-sm text-muted-foreground max-w-xl mx-auto mb-3">
            {SYARAT_CONTENT.intro}
          </p>
          <p className="text-caption text-muted-foreground">
            Terakhir diperbarui: {SYARAT_CONTENT.lastUpdated}
          </p>
        </header>
        ...
        <div className="space-y-10">
          {SYARAT_CONTENT.sections.map((section, sectionIndex) => (
