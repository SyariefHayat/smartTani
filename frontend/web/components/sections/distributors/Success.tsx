...
import { DISTRIBUTOR_TESTIMONI, DISTRIBUTOR_CTA_BANNER } from '@/constants/distributor';
              ...
              {DISTRIBUTOR_TESTIMONI.items.map((item, index) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-sm font-bold text-[#17391f]">{item.name}</h3>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-primary-dark p-10 text-white shadow-2xl lg:p-12 h-full">
            ...
            <div className="relative z-10 flex h-full flex-col">
              ...
              <div className="mt-auto space-y-4">
                ...
                >
                  <Link href="/signup?role=distributor">{DISTRIBUTOR_CTA_BANNER.cta[0].label}</Link>
                </Button>
