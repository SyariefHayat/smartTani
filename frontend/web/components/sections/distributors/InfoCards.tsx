...
import { Check, TrendingUp, ClipboardCheck, GraduationCap, Truck } from 'lucide-react';
import { DISTRIBUTOR_SYARAT, DISTRIBUTOR_STEPS, DISTRIBUTOR_MAP } from '@/constants/distributor';
      ...
      <div className="container-smarttani">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="flex flex-col rounded-[32px] bg-[#EAF3DE]/40 p-8 md:p-10 border border-[#EAF3DE] transition-all hover:shadow-md">
            ...
            <p className="mb-8 text-sm font-medium text-[#5d7a64]">{DISTRIBUTOR_SYARAT.subtext}</p>
            ...
            <div className="space-y-5 flex-1">
              {DISTRIBUTOR_SYARAT.items.map((item, index) => (
                <div key={index} className="flex items-start gap-4">
                  ...
                  <p className="text-sm font-bold text-[#17391f] leading-tight">{item}</p>
                </div>
              ))}
            </div>
          ...
          <div className="flex flex-col rounded-[32px] bg-[#EAF3DE]/40 p-8 md:p-10 border border-[#EAF3DE] transition-all hover:shadow-md">
            ...
            <p className="mb-10 text-sm font-medium text-[#5d7a64]">{DISTRIBUTOR_STEPS.subtext}</p>
          ...
          <div className="flex flex-col rounded-[32px] bg-[#EAF3DE]/40 p-8 md:p-10 border border-[#EAF3DE] transition-all hover:shadow-md">
            ...
            <div className="space-y-4">
              <h4 className="text-sm font-extrabold text-[#17391f]">Cari Distributor Terdekat</h4>
              <form
                onSubmit={(e) => {
                  e.preventDefault();
                  handleSearch();
