  ...
  return (
    <header className="py-8">
      ...
      <nav className="mb-8 flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#5d7a64]">
        ...
        <ChevronRight className="h-3 w-3" />
        <span className="line-clamp-1 font-extrabold text-[#17391f]">{article.title}</span>
      </nav>
      ...
      <div className="max-w-4xl">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-8 border-y border-slate-100 py-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-extrabold text-[#17391f]">{article.penulis.nama}</div>
              <div className="text-xs font-medium text-[#5d7a64]">{article.penulis.gelar}</div>
            </div>
          </div>
