    ...
    <section className="relative flex items-starts overflow-hidden min-h-[850px] md:min-h-[460px] lg:min-h-[420px]">
      ...
      <div className="absolute inset-0 z-0">
        <picture className="block w-full h-full">
          <source media="(min-width: 1024px)" srcSet={ARTICLE_HERO.bgImageDesktop} />
          <source
            media="(min-width: 768px) and (max-width: 1023px)"
            srcSet={ARTICLE_HERO.bgImageTablet}
          />
          <source media="(max-width: 767px)" srcSet={ARTICLE_HERO.bgImageMobile} />
          <img
      ...
      <div className="container-smarttani relative z-10 py-10 lg:py-0 mt-10 lg:mt-15">
        <div className="grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-12 lg:items-center lg:gap-8">
          ...
          <div className="lg:col-span-9">
            ...
            <h1 className="text-heading-1 text-white mb-3 max-w-xl">{ARTICLE_HERO.heading}</h1>

            <p className="text-body-sm mb-5 max-w-sm text-white/85">{ARTICLE_HERO.subtext}</p>
            ...
            >
              ...
              <Button
                type="submit"
                className="h-10 bg-primary px-4 md:px-6 text-sm font-bold !text-white transition-all hover:bg-primary-dark shrink-0 cursor-pointer"
              >
