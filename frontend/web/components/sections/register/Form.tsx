      ...
      case 'distributor':
        return {
          ...
          field2: {
            ...
            type: 'select',
            options: ['Lokal (Kecamatan)', 'Regional (Kabupaten)', 'Nasional'],
          },
        } as RoleFields;
      case 'investor':
        return {
          ...
          field1: {
            ...
            type: 'select',
            options: ['Individu / Perorangan', 'Institusi / Perusahaan'],
          },
          field2: {
            name: 'budgetRange',
            label: 'Rencana Budget Investasi',
            placeholder: 'Pilih range',
            type: 'select',
            options: ['Rp 1jt - 10jt', 'Rp 10jt - 50jt', 'Rp 50jt - 100jt', '> Rp 100jt'],
          },
        } as RoleFields;
      case 'mitra_bisnis':
        return {
          ...
          field1: {
            ...
            placeholder: 'Contoh: PT Agro Sejahtera',
            icon: Building2,
          },
          field2: {
      ...
      case 'admin_perusahaan':
        return {
          ...
          field1: {
            ...
            label: 'Nama Perusahaan Resmi',
            placeholder: 'Contoh: PT Smarttani Tech',
            icon: Building2,
          },
          field2: {
            name: 'position',
            ...
            type: 'select',
            options: ['Direktur / CEO', 'Manajer Operasional', 'Admin Sistem', 'Staf IT'],
          },
        } as RoleFields;
      case 'academy':
        return {
          ...
          field1: {
            ...
            placeholder: 'Contoh: Akademi Tani Muda',
            icon: Building2,
          },
          field2: {
            name: 'educationFocus',
            ...
            type: 'select',
            options: ['Teknologi Pertanian', 'Manajemen Agribisnis', 'Budidaya Organik', 'Lainnya'],
          },
        } as RoleFields;
      default:
        return null;
              ...
              <form onSubmit={handleSubmit} className="mt-6 grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    {password && (
                      <span
                        className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${strength.color}`}
                      >
                        {strength.label}
                      </span>
                    )}
                ...
                <div className="space-y-2">
                  ...
                  <Select required name="city" disabled={!selectedProvinsi}>
                    ...
                    <SelectContent>
                      {selectedProvinsi &&
                        regionData[selectedProvinsi]?.map((kota) => (
                          <SelectItem key={kota} value={kota.toLowerCase()}>
                            {kota}
                          </SelectItem>
                        ))}
                    </SelectContent>
                  ...
                  <>
                    <div className="md:col-span-2 pt-2">
                      <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-base font-bold text-gray-900">{extraFields.title}</h3>
                      </div>
                    ...
                    <div className="space-y-2">
                      ...
                      {extraFields.field1.type === 'select' ? (
                        ...
                        <div className="relative">
                          {extraFields.field1.icon && (
                            <extraFields.field1.icon className="absolute left-4 top-1/2 size-5 -translate-y-1/2 text-gray-400" />
                          )}
                          <Input
                    ...
                    <div className="space-y-2">
                      ...
                      {extraFields.field2.type === 'select' ? (
                        ...
                        <div className="relative">
                          {extraFields.field2.icon && (
                            <extraFields.field2.icon className="absolute left-4 top-1/2 size-5 -translate-y-1/2 text-gray-400" />
                          )}
                          <Input
                ...
                <div className="md:col-span-2 flex items-center gap-3">
                  <Checkbox
                    required
                    id="syarat"
                    className="shrink-0 border-slate-300 data-[state=checked]:bg-primary data-[state=checked]:border-primary"
                  />
                  <p className="text-xs font-bold leading-relaxed text-gray-700">
                    {REGISTER_TERMS.prefix}{' '}
                    <span className="text-primary cursor-pointer hover:underline">
                      {REGISTER_TERMS.syaratKetentuan}
                    </span>{' '}
                    {REGISTER_TERMS.conjunction}{' '}
                    <span className="text-primary cursor-pointer hover:underline">
                      {REGISTER_TERMS.kebijakanPrivasi}
                    </span>{' '}
