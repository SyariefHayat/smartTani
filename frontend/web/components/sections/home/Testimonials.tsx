          ...
          <div className="grid grid-cols-1 gap-6 md:gap-10 lg:grid-cols-12">
              ...
              <div className="grid grid-cols-3 gap-2.5">
                {HOME_CATEGORIES.slice(0, 6).map((item, index) => (
                  ...
                  >
                    ...
                    <p className="text-[11px] font-medium text-[#5d7a64] leading-tight">{item}</p>
                  </Link>
                ))}
                ...
                {HOME_CATEGORIES[6] && (
                  ...
                  >
                    ...
                    <p className="text-xs font-medium text-[#5d7a64]">{HOME_CATEGORIES[6]}</p>
                  </Link>
                )}
              </div>
            </div>
            ...
            <div className="lg:col-span-4">
              ...
              <div className="space-y-4">
                <div className="relative rounded-2xl bg-[#EAF3DE] p-6 shadow-sm min-h-[160px] flex flex-col justify-center">
            ...
            <div className="lg:col-span-4 bg-white">
              ...
              <div className="space-y-5">
                {(HOME_ARTICLE as HomeArticleItem[]).map((item, index) => {
