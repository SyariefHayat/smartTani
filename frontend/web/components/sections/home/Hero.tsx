...
import { HERO_ACTION, HOME_HERO, HOME_HERO_STATS, STAT_ICONS } from '@/constants';
      ...
      <div className="absolute inset-0 z-0">
        <picture className="block w-full h-full">
          ...
          <source
            ...
            srcSet={HOME_HERO.bgImageTablet}
          />
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        >
                          <Icon className="size-7" style={{ color: item.iconColor }} />
                        </div>
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="mt-0.5 flex items-center gap-2">
                            ...
                            <p className="text-caption" style={{ color: item.sublabelColor }}>
                              {item.sublabel}
                            </p>
                          </div>
                        </div>
