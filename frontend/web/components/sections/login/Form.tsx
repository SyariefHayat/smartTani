    ...
    <div className={cn('flex flex-col gap-6', className)} {...props}>
      <Card>
        <CardHeader className="text-center">
          <CardTitle className="text-xl font-bold">{LOGIN_FORM.title}</CardTitle>
          <CardDescription>{LOGIN_FORM.description}</CardDescription>
        </CardHeader>
        ...
        <CardContent>
          ...
          <div className="mt-8 pt-7 border-t border-slate-200 text-center space-y-3">
            ...
            <p className="text-[11px] leading-relaxed text-slate-400 max-w-[300px] mx-auto font-medium">
              ...
              <Link
                href="/terms"
                className="hover:text-primary transition-colors underline decoration-slate-200 underline-offset-2"
              >
