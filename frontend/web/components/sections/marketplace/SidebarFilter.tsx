...
import { MARKETPLACE_KATEGORI_SIDEBAR, MARKETPLACE_FILTER } from '@/constants/marketplace';
...
function SidebarFilterContent({ className, onClose }: SidebarFilterProps) {
  ...
  return (
    <aside
      className={cn(
        'bg-white rounded-xl border border-border shadow-sm p-5 space-y-6 overflow-y-auto max-h-full',
        className
      )}
    >
