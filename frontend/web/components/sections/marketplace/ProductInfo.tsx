    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <div className="mt-2 flex items-center gap-4">
          <Badge className="bg-[#1A6B2F] hover:bg-[#145224]">{product.storeType}</Badge>
      ...
      <div className="space-y-1">
        <div className="text-3xl font-bold text-[#1A6B2F]">{formatPrice(product.price)}</div>
      ...
      <div className="space-y-4 border-y border-gray-100 py-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center rounded-lg border border-gray-200">
            ...
            <input
              ...
              value={qty}
              onChange={(e) =>
                setQty(Math.min(maxStock, Math.max(1, parseInt(e.target.value) || 1)))
              }
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          <Button className="bg-[#1A6B2F] hover:bg-[#145224]" onClick={buyNow}>
            Beli Sekarang
          </Button>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-gray-100 bg-gray-50 p-4">
        <div className="text-xs font-semibold uppercase tracking-wider text-gray-500">Penjual</div>
