        ...
        {INVESTMENT_FAQ.items.map((item, index) => (
          ...
          >
            ...
            <AccordionContent className="text-xs md:text-sm font-medium text-[#5d7a64] pb-4">
              Jawaban untuk pertanyaan ini akan segera diperbarui. Silakan hubungi tim dukungan kami
              untuk informasi lebih lanjut mengenai investasi di Smarttani.
            </AccordionContent>
          </AccordionItem>
        ))}
      </Accordion>
