...
interface InvestmentDetailHeroProps {
  project: {
    title: string;
    image: string;
    kategori: string;
...
export default function InvestmentDetailHero({ project }: InvestmentDetailHeroProps) {
  return (
    <section className="relative overflow-hidden bg-gray-900 py-20 text-white">
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="max-w-3xl">
          <Badge className="bg-[#BA7517] hover:bg-[#a06514] mb-4">{project.kategori}</Badge>
