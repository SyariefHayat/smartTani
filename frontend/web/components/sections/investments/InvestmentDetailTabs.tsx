...
export default function InvestmentDetailTabs() {
      ...
      <div className="py-8">
        {activeTab === 'overview' && (
          <div className="prose max-w-none text-gray-600">
            ...
            <p>
              Proyek ini difokuskan pada pengembangan pertanian berkelanjutan dengan pemanfaatan
              teknologi modern untuk meningkatkan hasil panen dan efisiensi operasional. Kami
              bekerja sama dengan petani lokal berpengalaman untuk memastikan keberhasilan proyek.
            </p>
            <p className="mt-4">
              Dana yang terkumpul akan digunakan untuk pengadaan bibit unggul, pupuk organik, sistem
              irigasi cerdas, serta biaya operasional selama masa tanam hingga panen.
            </p>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-50">
                  ...
                  <th className="p-4 text-sm font-bold text-gray-900 border-b">
                    Proyeksi Pendapatan
                  </th>
                ...
                {[
                  {
                    ...
                    profit: 'Rp 150.000.000',
                    roi: '12,5%',
                  },
                  {
                    tahun: 'Tahun 2',
                    pendapatan: 'Rp 1.500.000.000',
                    profit: 'Rp 210.000.000',
                    roi: '14,0%',
                  },
                  {
                    tahun: 'Tahun 3',
                    pendapatan: 'Rp 1.850.000.000',
                    profit: 'Rp 277.500.000',
                    roi: '15,0%',
                  },
                ].map((row, i) => (
            ...
            {[
              {
                name: 'Arif Wijaya',
                role: 'Manager Proyek',
                image: '/images/about/director-arif-wijaya.jpeg',
              },
              {
                name: 'Budi Santoso',
                role: 'Ahli Agronomi',
                image: '/images/about/director-budi-santoso.jpeg',
              },
              {
                name: 'Siti Aminah',
                role: 'Ops Manager',
                image: '/images/about/director-siti-aminah.jpeg',
              },
            ].map((member, i) => (
        ...
        {activeTab === 'update' && (
          <div className="space-y-8">
            {[
              {
                title: 'Persiapan Lahan Selesai',
                date: '10 April 2024',
                desc: 'Lahan telah siap ditanami, irigasi sudah terpasang.',
                status: 'Completed',
              },
              {
                title: 'Penanaman Bibit Tahap 1',
                date: '15 April 2024',
                desc: 'Sebanyak 10.000 bibit telah ditanam.',
                status: 'In Progress',
              },
              {
                title: 'Pemupukan Pertama',
                date: '30 April 2024',
                desc: 'Pemupukan dasar menggunakan pupuk organik.',
                status: 'Upcoming',
              },
            ].map((update, i) => (
              <div key={i} className="flex gap-4">
                <div className="flex flex-col items-center">
                  <div
                    className={`h-8 w-8 rounded-full flex items-center justify-center ${i === 0 ? 'bg-[#1A6B2F]' : 'bg-gray-200'}`}
                  >
