...
export default function FormInfo() {
  ...
  const getContactHref = (type: string, value: string) => {
    if (type === 'WhatsApp' || type === 'Telepon' || type === 'Nomor HP')
            ...
            {isSubmitted ? (
              <div className="flex flex-col items-center justify-center py-10 text-center animate-in fade-in zoom-in-95 duration-500">
                ...
                <p className="text-base font-medium text-[#5d7a64] max-w-md">
                  Pesan Anda telah berhasil dikirim! Tim kami akan menghubungi Anda kembali dalam
                  waktu 1x24 jam.
                </p>
                <Button
              ...
              <>
                <div className="mb-8">
                  ...
                  <p className="text-sm font-medium text-[#5d7a64]">{CONTACT_FORM.subtext}</p>
                </div>
