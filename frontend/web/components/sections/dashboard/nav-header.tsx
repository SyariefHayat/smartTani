    ...
    <header className="flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 border-b">
      <div className="flex items-center justify-between w-full px-4">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          <Button variant="ghost" size="icon" className="h-9 w-9 sm:w-auto sm:px-3 sm:gap-1.5">
            ...
            <DropdownMenuTrigger asChild>
              ...
              >
                ...
                <div className="hidden sm:flex flex-col text-left text-xs leading-none">
                  <span className="font-semibold truncate max-w-20">{user?.name}</span>
                </div>
              ...
              <DropdownMenuLabel className="p-0 font-normal text-black">
                <div className="flex items-center gap-2 px-1 py-1.5 text-left text-sm">
                  ...
                  <div className="grid flex-1 text-left text-sm leading-tight">
                    ...
                    <span className="text-muted-foreground mt-0.5">{formatRole(user?.role)}</span>
                  </div>
                </div>
              </DropdownMenuLabel>
              <DropdownMenuSeparator />
