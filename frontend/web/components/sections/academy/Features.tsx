...
import { BookOpen, Clock, Award, Users, LifeBuoy, ChevronRight } from 'lucide-react';
        ...
        <div className="rounded-[32px] bg-[#EAF3DE]/40 p-6 md:p-10">
          ...
          <div className="mb-10 flex flex-col items-center text-center">
            ...
            <p className="mt-2 max-w-2xl text-sm font-medium text-[#5d7a64] md:text-base">
              Kami menyediakan ekosistem pembelajaran yang dirancang khusus untuk meningkatkan
              kompetensi dan hasil panen petani Indonesia.
            </p>
          </div>
              ...
              return (
                <div key={feature.title} className="flex flex-col items-center text-center group">
                  ...
                  <div className="flex flex-col flex-1 items-center">
                    <h3 className="mb-2 text-lg font-extrabold text-[#17391f]">{feature.title}</h3>
