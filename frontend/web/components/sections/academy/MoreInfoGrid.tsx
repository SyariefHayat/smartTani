...
import { ACADEMY_WEBINARS, ACADEMY_CTA_BANNER } from '@/constants/academy';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-10 items-stretch">
          ...
          <div className="md:col-span-1 lg:col-span-4 flex flex-col h-full">
            ...
            <div className="flex flex-col gap-4 flex-1">
              {webinars.map((item, idx) => (
                <div
                  key={idx}
                  className="flex items-center gap-4 bg-[#EAF3DE]/40 p-4 rounded-xl border border-gray-100 shadow-sm transition-all hover:border-gray-300 flex-1"
                >
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="h-8 px-4 text-xs font-bold border-primary text-primary hover:bg-primary hover:text-white rounded-lg shrink-0 transition-all"
                  >
                    Daftar
                  </Button>
                </div>
              ...
              {articles.map((item, idx) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[11px] font-medium text-[#5d7a64] mt-1.5">{item.tanggal}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="md:col-span-1 lg:col-span-4 relative overflow-hidden bg-[#1a4d2e] rounded-3xl p-8 sm:p-10 flex flex-col text-white h-full shadow-xl shadow-primary/10">
            ...
            <div className="absolute inset-0 z-0">
              <picture>
                <source media="(min-width: 1024px)" srcSet="/images/home/cta-desktop.webp" />
                <source media="(min-width: 640px)" srcSet="/images/home/cta-tablet.png" />
                <img
