  ...
  return (
    <section className="relative overflow-hidden bg-gray-900 py-20 text-white">
      ...
      <div className="absolute inset-0 z-0">
        <Image src={course.image} alt={course.title} fill className="object-cover opacity-30" />
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex items-center gap-4">
            ...
            <div>
              <div className="text-sm font-bold text-white">{course.instruktur.nama}</div>
              <div className="text-xs text-white/70">{course.instruktur.gelar}</div>
            </div>
          </div>
          ...
          <div className="mt-12 grid grid-cols-2 gap-4 sm:grid-cols-4">
            {[
              ...
              >
                ...
                <div className="text-[11px] uppercase font-semibold text-white/60 leading-tight">
                  {stat.label}
                </div>
