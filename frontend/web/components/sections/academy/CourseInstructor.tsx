        ...
        <div className="flex-1">
          ...
          <div className="mt-6 text-[#5d7a64] leading-relaxed font-medium">
            <p>
              ...
              pertanian modern dengan spesialisasi pada optimasi hasil panen dan manajemen sumber
              daya. Telah membimbing ribuan petani di seluruh Indonesia untuk menerapkan teknik
              bertani yang lebih efektif dan berkelanjutan.
            </p>
          </div>
        </div>
      </div>
