...
import { CalendarDays, Users, Store, MapPin, GraduationCap, Package } from 'lucide-react';

const STAT_ICONS = [CalendarDays, Users, Store, MapPin, GraduationCap, Package];
        ...
        <div className="rounded-2xl bg-white shadow-[0_12px_40px_rgba(0,0,0,0.08)]">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 py-8 md:px-4 lg:px-0 gap-y-8 md:gap-y-0 items-start">
            {ABOUT_STATS_BAR.map((item, index) => {
              ...
              return (
                <div key={item.label} className="relative flex flex-col items-center px-4">
