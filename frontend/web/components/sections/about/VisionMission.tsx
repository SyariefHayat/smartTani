      ...
      <div className="container-smarttani">
        ...
        <div id="visi-misi" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="group bg-white p-8 rounded-3xl border border-slate-100 flex flex-col items-center text-center shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <h3 className="text-xl font-extrabold text-[#17391f] mb-4">{ABOUT_VISION.heading}</h3>
          ...
          <div className="group bg-white p-8 rounded-3xl border border-slate-100 flex flex-col items-center text-center shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <h3 className="text-xl font-extrabold text-[#17391f] mb-4">{ABOUT_MISSION.heading}</h3>
            <ul className="space-y-4 w-full">
              {ABOUT_MISSION.items.map((misi, index) => (
                <li key={index} className="flex items-start gap-3 text-left">
                  <CheckCircle2 className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                  <span className="text-sm font-medium text-[#5d7a64] leading-relaxed">{misi}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="group bg-white p-8 rounded-3xl border border-slate-100 flex flex-col items-center text-center shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <h3 className="text-xl font-extrabold text-[#17391f] mb-4">{ABOUT_VALUES.heading}</h3>
