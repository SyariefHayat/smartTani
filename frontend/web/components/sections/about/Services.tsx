...
import { ShoppingCart, TrendingUp, Store, Truck, GraduationCap, FileText } from 'lucide-react';

const LAYANAN_ICONS = [ShoppingCart, TrendingUp, Store, Truck, GraduationCap, FileText];
