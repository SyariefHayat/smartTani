        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-[#EAF3DE]/40 rounded-[32px] p-6 border border-[#EAF3DE] flex flex-col items-center text-center">
            ...
            <div className="mt-auto w-full grid grid-cols-3 pt-4 border-t border-[#d4edda]">
              {LOGISTICS_COVERAGE.stats.map((stat, index) => (
                <div
                  key={index}
                  className={`flex flex-col items-center ${index < 2 ? 'border-r border-[#d4edda]' : ''}`}
                >
                  <span className="text-lg font-extrabold text-primary md:text-xl">
                    {stat.value}
                  </span>
                  <span className="text-[10px] font-bold text-[#5d7a64] uppercase tracking-wider">
                    {stat.label}
                  </span>
                </div>
              ))}
          ...
          <div className="bg-[#EAF3DE]/40 rounded-[32px] p-6 border border-[#EAF3DE] flex flex-col">
            ...
            <form className="space-y-3" onSubmit={calculateOngkir}>
              ...
              <Button
                type="submit"
                className="w-full h-11 bg-primary hover:bg-primary-dark !text-white font-bold flex items-center justify-center gap-2 cursor-pointer shadow-lg shadow-primary/20 rounded-xl transition-all active:scale-95"
              >
