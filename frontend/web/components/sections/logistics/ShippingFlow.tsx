...
import { ClipboardList, Package, Warehouse, Truck, MapPin, CheckCircle2 } from 'lucide-react';

const STEP_ICONS = [ClipboardList, Package, Warehouse, Truck, MapPin, CheckCircle2];
