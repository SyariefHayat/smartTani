...
import { FOOTER_SECTIONS, SOCIAL_LINKS, FOOTER_BRAND } from '@/constants';
        ...
        <div className="grid grid-cols-3 gap-x-6 gap-y-10 md:hidden">
          ...
          {FOOTER_SECTIONS.map((section, index) => {
            ...
            return (
              <div
                key={section.title}
                className={cn(isLast ? 'col-span-3' : 'col-span-1', 'flex flex-col')}
              >
...
function BrandColumn() {
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-white/70 leading-relaxed md:w-84 lg:w-auto">
    ...
    <div className={className}>
      ...
      <div className="flex items-center gap-3 lg:flex-col lg:items-start">
        <div className="flex flex-col gap-2">
          <a href="#" target="_blank">
            <Image
              ...
              width={120}
              height={36}
              className="h-11 md:h-14 lg:h-11 w-auto"
            />
          </a>
          <a href="#" target="_blank">
            <Image
        ...
        <Image
          ...
          width={100}
          height={100}
          className="h-24 md:h-32 lg:h-24 w-auto rounded"
        />
      </div>
    </div>
  );
