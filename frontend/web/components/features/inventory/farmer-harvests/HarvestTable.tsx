...
export function HarvestTable<TData>({ table, columnsCount, isLoading }: HarvestTableProps<TData>) {
          ...
          <div className="text-sm text-muted-foreground">
            {isLoading ? (
              ...
              <>
                ...
                dari <span className="font-semibold text-slate-900">{totalRows}</span> panen
              </>
            )}
          </div>
