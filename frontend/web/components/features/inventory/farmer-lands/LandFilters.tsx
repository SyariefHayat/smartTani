          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              ...
              >
                ...
                <span className="truncate">Status Lahan</span>
                {currentStatusFilter && (
                  <Badge
                    variant="secondary"
            ...
            <DropdownMenuContent align="start" className="w-56">
              <DropdownMenuGroup>
                <DropdownMenuLabel>Filter Status Lahan</DropdownMenuLabel>
                <DropdownMenuSeparator />
                {(['active', 'fallow', 'rented'] as const).map((status) => (
                  <DropdownMenuItem
                    key={status}
