          ...
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data}>
                ...
                />
                <Legend />
                <Bar dataKey="farmer" name="Petani" fill="#16a34a" radius={[4, 4, 0, 0]} />
                <Bar dataKey="buyer" name="Buyer" fill="#2563eb" radius={[4, 4, 0, 0]} />
                <Bar dataKey="investor" name="Investor" fill="#9333ea" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        )}
