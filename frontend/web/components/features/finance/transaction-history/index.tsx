...
export function TransactionHistoryManagement() {
  ...
  const handlePrintReport = React.useCallback(() => {
    ...
    setTimeout(() => {
      toast.dismiss();
      toast.success('Laporan transaksi siap dicetak. Dialog print browser dibuka.');
    }, 1500);
  }, []);
      ...
      <div className="mx-auto flex w-full flex-col gap-6">
        {useDemo && (
          <div className="flex items-center gap-2 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-xs text-amber-800 font-semibold shadow-xs">
            ...
            <p>
              Mode Offline Simulai: Koneksi ke server keuangan terputus. Menampilkan riwayat demo
              lokal agar Anda tetap dapat menjelajahi layout.
            </p>
          </div>
        )}
