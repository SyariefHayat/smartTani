...
export function InvestorPortfolio() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'paid':
        return (
          <Badge className="bg-blue-100 text-blue-700 hover:bg-blue-100 border-none">Aktif</Badge>
        );
      case 'completed':
        return (
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Ditempatkan di {summary?.total_investments || 0} proyek
            </p>
          </CardContent>
        </Card>
            ...
            {isLoading ? (
              ...
              <TableRow>
                <TableCell colSpan={6} className="text-center py-20 text-gray-500">
                  ...
                  Anda belum memiliki investasi. Mulailah berinvestasi pada proyek tani yang
                  tersedia.
                </TableCell>
              </TableRow>
            ) : (
