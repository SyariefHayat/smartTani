...
export default function NotFound() {
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center bg-white px-4 text-center">
      ...
      <h2 className="text-3xl font-bold text-gray-900 md:text-4xl">Halaman Tidak Ditemukan</h2>
      <p className="mt-4 max-w-md text-gray-500">
        Maaf, halaman yang Anda cari tidak tersedia atau telah dipindahkan. Mari kembali ke jalur
        yang benar.
      </p>
      ...
      <div className="mt-10 flex flex-col gap-4 sm:flex-row">
        <Button
          asChild
          className="bg-[#1A6B2F] hover:bg-[#145224] px-8 py-6 rounded-full text-lg shadow-lg"
        >
          <Link href="/">
        ...
        <Button
          asChild
          variant="outline"
          className="border-[#1A6B2F] text-[#1A6B2F] hover:bg-[#1A6B2F]/5 px-8 py-6 rounded-full text-lg"
        >
          <Link href="/contact">
