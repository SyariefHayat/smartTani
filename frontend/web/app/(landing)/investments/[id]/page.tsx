...
export default async function InvestasiDetailPage({ params }: InvestasiDetailPageProps) {
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
          ...
          <div className="relative">
            <InvestmentForm projectTitle={project.title} minInvestasi={project.minimalInvestasi} />
          </div>
        </div>
