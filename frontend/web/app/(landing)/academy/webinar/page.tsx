...
import { AcademyWebinar } from '@/constants/types';
...
export default function WebinarPage() {
  ...
  const [selectedEvent, setSelectedEvent] = useState<AcademyWebinar | null>(null);
      ...
      <section className="bg-primary py-12 text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-2xl">
            <Badge className="bg-white/20 text-white border-none mb-4">SiTani Academy</Badge>
            <h1 className="text-3xl font-bold md:text-4xl">{ACADEMY_WEBINARS.heading}</h1>
            <p className="mt-3 text-white/80 text-lg">{ACADEMY_WEBINARS.subtext}</p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 mt-16">
        <div className="rounded-[2.5rem] bg-white p-8 md:p-12 text-center shadow-sm border border-slate-100">
          ...
          <p className="mt-4 text-gray-500 max-w-2xl mx-auto">
            Kami terbuka untuk kolaborasi dengan pakar, institusi, maupun perusahaan untuk berbagi
            ilmu di ekosistem Smarttani.
          </p>
          <div className="mt-8 flex justify-center">
            <Button
              asChild
              variant="outline"
              className="h-12 px-8 rounded-xl font-bold border-primary text-primary hover:bg-primary/5"
            >
              <Link href="/contact">
              ...
              <div className="space-y-6 flex-1">
                ...
                <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100">
                  <p className="text-xs text-gray-500 leading-relaxed">
                    Dengan mendaftar, Anda setuju untuk menerima informasi terkait event ini dan
                    materi pembelajaran dari SiTani Academy melalui email.
                  </p>
                </div>
              </div>
