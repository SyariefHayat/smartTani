              ...
              <div key={jalur.level} className="relative">
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-8 mb-12">
                  <div className="flex-1">
                    <Badge
                      className={`mb-4 px-4 py-1 rounded-full font-bold border ${levelStyles[jalur.level]}`}
                    >
                      Jalur {jalur.level}
                    </Badge>
                    ...
                    <p className="text-gray-600 text-lg leading-relaxed">{jalur.description}</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="bg-slate-50 rounded-2xl border border-dashed border-slate-200 p-4 flex flex-col items-center justify-center text-center opacity-60">
                    ...
                    <p className="text-xs font-bold text-slate-400">
                      +{jalur.jumlahKursus - 2} Kursus Lainnya
                    </p>
                  </div>
                </div>
                ...
                {idx < ACADEMY_LEARNING_PATHS.items.length - 1 && (
                  <div className="flex flex-col items-center mt-24">
                    ...
                    <div className="bg-slate-50 px-6 py-2 rounded-full border border-slate-100 text-xs font-bold text-slate-400 flex items-center gap-3">
                      <span>
                        Selesaikan Jalur {jalur.level} untuk membuka Jalur{' '}
                        {ACADEMY_LEARNING_PATHS.items[idx + 1].level}
                      </span>
        ...
        <div className="rounded-[3rem] bg-primary-dark p-8 md:p-16 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-6 text-white/70 text-lg max-w-2xl mx-auto">
              Tingkatkan pengetahuan Anda langkah demi langkah. Bergabunglah sekarang dan jadilah
              bagian dari revolusi pertanian digital.
            </p>
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                asChild
                className="bg-accent hover:bg-accent/90 h-14 px-10 rounded-2xl font-bold !text-white text-lg shadow-xl shadow-black/20 transition-all active:scale-95"
              >
              ...
              <Button
                asChild
                variant="outline"
                className="h-14 px-10 rounded-2xl font-bold border-white/20 bg-white/10 text-white hover:bg-white/20 text-lg transition-all active:scale-95"
              >
