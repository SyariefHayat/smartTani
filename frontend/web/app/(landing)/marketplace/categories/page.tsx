    ...
    <main className="min-h-screen bg-slate-50 pb-20">
      ...
      <section className="bg-primary py-12 text-white">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl font-bold md:text-4xl">Semua Kategori Marketplace</h1>
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
          {MARKETPLACE_KATEGORI_SIDEBAR.map((cat) => (
            ...
            >
              ...
              <p className="text-sm text-gray-500 mt-1">{cat.count} Produk</p>
            </Link>
          ))}
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 mt-12">
        <div className="rounded-[2.5rem] bg-white p-8 md:p-12 text-center shadow-sm border border-slate-100">
          ...
          <p className="mt-4 text-gray-500 max-w-2xl mx-auto">
            Kami terus memperbarui daftar produk kami. Anda dapat menjelajahi semua produk atau
            menghubungi tim kami jika membutuhkan bantuan khusus.
          </p>
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button
              asChild
              className="bg-primary hover:bg-primary-dark h-12 px-8 rounded-xl font-bold !text-white"
            >
