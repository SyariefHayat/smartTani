        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <Button
              asChild
              variant="outline"
              className="w-fit border-primary text-primary hover:bg-primary/5 rounded-xl font-bold"
            >
        ...
        {filteredAndSortedProducts.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 bg-slate-50 rounded-[2.5rem] border border-dashed border-slate-200">
            ...
            <p className="text-gray-500 mt-2 text-center max-w-sm">
              Maaf, kami tidak dapat menemukan produk yang sesuai dengan kata kunci &quot;
              {searchQuery}&quot;.
            </p>
            <Button
              variant="outline"
