...
import { TERMS_META, TERMS_CONTENT } from '@/constants/terms';
      ...
      <article className="container-smarttani max-w-3xl mx-auto py-12 md:py-16 lg:py-20">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-caption text-muted-foreground">
            Terakhir diperbarui: {TERMS_CONTENT.lastUpdated}
          </p>
        </header>
        ...
        <div className="space-y-10">
          {TERMS_CONTENT.sections.map((section, sectionIndex) => (
            <section key={sectionIndex}>
              <h2 className="text-heading-3 text-foreground mb-4">{section.title}</h2>
