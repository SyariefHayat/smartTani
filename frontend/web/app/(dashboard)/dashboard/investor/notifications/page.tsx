...
import { Bell, BellRing, Landmark, Sprout, Info, Search, CheckCheck, Check } from 'lucide-react';
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">
              Pantau info pembagian hasil panen, penawaran proyek baru, dan pemberitahuan kemitraan
              lahan Anda.
            </p>
          </div>
        </div>
        ...
        <Card className="border border-slate-200 shadow-sm bg-white overflow-hidden">
          <CardHeader className="pb-3 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-100">
            <div className="flex flex-wrap gap-1.5">
              {[
                { id: 'all', label: 'Semua' },
                { id: 'order', label: 'Investasi & Cair' },
                { id: 'promo', label: 'Proyek Baru' },
                          ...
                          {!item.is_read && (
                            <div className="flex items-center self-center shrink-0">
                              <Button
                                ...
                                size="icon"
                                title="Tandai dibaca"
                                className="h-7 w-7 rounded-full bg-white hover:bg-green-50 hover:text-green-600 border border-slate-100 shadow-xs cursor-pointer flex items-center justify-center"
