...
export const LOGISTICS_HERO = {
  ...
  badges: [
    ...
    { label: 'Terintegrasi Penuh', sublabel: 'Sistem Digital Real-time' },
  ],
  tracking: {
    label: 'Lacak Kiriman Anda',
...
export const LOGISTICS_SERVICES = {
  heading: 'Layanan Logistik Smarttani',
  subtext: 'Solusi lengkap untuk rantai pasok pertanian yang efisien dan terintegrasi',
  items: [
    {
      title: 'Pengiriman Hasil Panen',
      description: 'Distribusi hasil pertanian segar ke pasar, pabrik, atau gudang.',
      image: '/images/logistics/pengiriman-hasil-panen.png',
      cta: 'Selengkapnya →',
    },
    {
      title: 'Distribusi Sarana Produksi',
      description: 'Pengiriman pupuk, benih, dan alat pertanian ke seluruh indonesia.',
      image: '/images/logistics/distribusi-sarana-produksi.png',
      cta: 'Selengkapnya →',
    },
    {
      title: 'Pergudangan & Penyimpanan',
      description: 'Fasilitas gudang modern dengan sistem manajemen stok terintegrasi.',
      image: '/images/logistics/pergudangan.png',
      cta: 'Selengkapnya →',
    },
    {
      title: 'Pengiriman Antar Pulau',
      description: 'Layanan kargo laut dan udara untuk jangkauan ke seluruh nusantara.',
    ...
    },
    {
      ...
      description: 'Pantau status pengiriman Anda kapan saja melalui sistem terintegrasi.',
...
export const LOGISTICS_COVERAGE = {
...
export const LOGISTICS_ADVANTAGES = {
  heading: 'Keunggulan Smarttani Logistik',
  tagline: 'Kami berkomitmen menjadi tulang punggung logistik pertanian Indonesia.',
  items: [
    'Jaringan transportasi luas & terpercaya',
    'Sistem manajemen logistik terintegrasi',
...
export const LOGISTICS_CHECK_SHIPPING_COST = {
  heading: 'Cek Ongkir Instan',
  subtext: 'Hitung estimasi biaya pengiriman dengan mudah',
  fields: {
    dari: { label: 'Dari', placeholder: 'Pilih Kota Asal' },
    ke: { label: 'Ke', placeholder: 'Pilih Kota Tujuan' },
    jenisBarang: { label: 'Jenis Barang', placeholder: 'Pilih Jenis Barang' },
    berat: { label: 'Berat (kg)', placeholder: 'Contoh: 100' },
  },
  cta: 'Cek Ongkir',
};

export const SHIPPING_FLOW = {
  heading: 'Alur Pengiriman yang Mudah',
  items: [
    {
      step: 1,
      title: 'Pesan Layanan',
      description: 'Pilih layanan logistik sesuai kebutuhan Anda.',
    },
    {
      step: 2,
      title: 'Jemput Barang',
      description: 'Tim kami menjemput barang di lokasi Anda.',
    },
    {
      step: 3,
      title: 'Proses & Sortir',
      description: 'Barang diproses dan disortir di gudang terdekat.',
    },
    {
      step: 4,
      title: 'Pengiriman',
      description: 'Barang dikirim melalui moda transportasi terbaik.',
    },
    {
      step: 5,
      title: 'Pelacakan',
    ...
    },
    {
      step: 6,
      title: 'Sampai Tujuan',
      description: 'Barang diterima dengan aman dan tepat waktu.',
    },
  ],
};
...
export const LOGISTICS_CTA_BANNER = {
  heading: 'Butuh Solusi Logistik untuk Bisnis Pertanian Anda?',
  subtext: 'Tim kami siap membantu dengan solusi terbaik yang disesuaikan dengan kebutuhan Anda.',
