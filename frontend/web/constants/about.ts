...
export const ABOUT_TIMELINE = {
  ...
  items: [
    {
      tahun: '2019',
      keterangan: 'Didirikan dengan visi mendukung pertanian melalui teknologi.',
    },
    {
      tahun: '2020',
    ...
    {
      tahun: '2024',
      keterangan: 'Terus berinovasi menjadi ekosistem pertanian digital terpadu.',
    },
  ],
};
...
export const ABOUT_LAYANAN = {
  ...
  subtext: 'Ekosistem terintegrasi untuk memenuhi setiap kebutuhan dalam rantai pasok pertanian.',
  items: [
    {
      title: 'Marketplace',
      description: 'Platform jual beli input pertanian berkualitas dengan harga terbaik.',
    },
    {
      title: 'Investasi',
      description: 'Peluang investasi pertanian yang aman, transparan, and menguntungkan.',
    },
    {
      title: 'Distributor',
      description: 'Jaringan distribusi luas untuk memastikan produk sampai ke petani.',
    },
    {
      title: 'Logistik',
      description: 'Layanan pengiriman cepat, aman, and terintegrasi ke seluruh Indonesia.',
    },
    {
      title: 'SiTani Academy',
      description: 'Edukasi and pelatihan praktis untuk meningkatkan keterampilan petani.',
    },
    {
      title: 'Artikel',
      description: 'Informasi terbaru, tips, and insight seputar dunia pertanian.',
    },
  ],
};
