...
export const INVESTMENT_ADVANTAGES = {
  ...
  items: [
    ...
    },
    {
      ...
      description: 'Pantau perkembangan proyek dan penggunaan dana secara real-time.',
    },
    {
  ...
  taglineSubtext: 'Bergabunglah dengan ribuan investor yang telah merasakan manfaatnya.',
