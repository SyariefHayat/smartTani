...
export const ACADEMY_HERO = {
  ...
  sidebar: {
    ...
    subtext: 'Ribuan petani telah meningkatkan hasil panen mereka bersama kami.',
...
export const ACADEMY_MODEL_PELATIHAN = {
  ...
  items: [
    ...
    },
    {
      ...
      description: 'Belajar langsung bersama instruktur dan praktik di lapangan.',
  ...
  items: [
    {
      ...
      description: 'Teknik lengkap dari pemilihan benih hingga panen untuk hasil maksimal.',
    ...
    },
    {
      ...
      description: 'Belajar hidroponik sederhana dengan biaya cepat dan menguntungkan.',
    ...
    },
    {
      ...
      description: 'Panduan lengkap manajemen pakan, kesehatan, dan reproduksi.',
    ...
    },
    {
      ...
      description: 'Cara mengurangi kehilangan hasil dan meningkatkan nilai jual produk.',
...
export const ACADEMY_LEARNING_PATHS = {
  ...
  items: [
    ...
    {
      level: 'Ahli',
      description: 'Kuasai strategi tingkat lanjut dan menjadi ahli di bidangnya.',
      jumlahKursus: 25,
      jumlahJam: 50,
    },
  ],
...
export const ACADEMY_TESTIMONIALS = {
  ...
  subtext:
    'Ribuan petani telah merasakan manfaat nyata dari program pembelajaran di SiTani Academy.',
  items: [
    {
      nama: 'Siti Aminah',
...
export const ACADEMY_CTA_BANNER = {
  ...
  subtext: 'Bergabunglah dengan ribuan petani yang telah meningkatkan hasil dan pendapatan mereka.',
