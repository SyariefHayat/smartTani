...
export const HOME_HERO = {
  ...
  subtext: 'Gabung gerakan Smart Farming, wujudkan pangan mandiri',
...
export const HOME_FEATURES = [
  {
    ...
    description: 'Jual dan beli hasil pertanian langsung dari petani dengan harga terbaik.',
    cta: 'Lihat Produk →',
  },
  {
    title: 'Investasi Pertanian',
    description: 'Danai proyek pertanian potensial dan dapatkan keuntungan menjanjikan.',
    cta: 'Mulai Investasi →',
  },
  {
    title: 'Distributor & Supply Chain',
    description: 'Kelola stok, gudang, dan distribusi secara efisien dan transparan.',
    cta: 'Jelajahi →',
  },
  {
    title: 'Logistik Terintegrasi',
    description: 'Layanan pengiriman cepat dan aman hingga ke seluruh Indonesia.',
    cta: 'Cek Tarif →',
  },
  {
    title: 'Pelatihan SiTani Academy',
    description: 'Tingkatkan pengetahuan dan keterampilan dengan pelatihan bersertifikat.',
    cta: 'Mulai Belajar →',
  },
  {
    title: 'Artikel & Berita Tani',
    description: 'Baca tips, tren, dan informasi terkini seputar dunia pertanian dari para ahli.',
    cta: 'Baca Artikel →',
  },
];
...
export const HOME_CATEGORIES = ['Gabah', 'Beras', 'Jagung', 'Sayur', 'Buah', 'Kedelai'];
...
export const HOME_CTA_BANNER = {
  ...
  subtext: 'Ribuan petani, investor, dan mitra telah merasakan manfaatnya. Sekarang giliran Anda!',
